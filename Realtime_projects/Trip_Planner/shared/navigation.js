...
class PhaseNavigation {
  ...
  loadSubphases() {
    ...
    const phaseSubphases = {
      ...
      'uiux': [
        ...
        { id: 'discovery-interface', file: 'Discovery_Interface.html', label: 'Discovery Interface', icon: '🖥️' },
        { id: 'itinerary-builder', file: 'Itinerary_Builder.html', label: 'Itinerary Builder', icon: '📅' },
        { id: 'wireframes', file: 'Wireframes.html', label: 'Wireframes', icon: '🗺️' },
        { id: 'conclusion', file: 'Conclusion.html', label: 'Conclusion', icon: '✅' }
      ],
      'architectural': [
        { id: 'overview', file: 'Overview_Content.html', label: 'Overview', icon: '🏗️' },
        { id: 'system-architecture', file: 'System_Architecture.html', label: 'System Architecture', icon: '📡' },
        { id: 'database-schema', file: 'Database_Schema.html', label: 'Database Schema', icon: '💾' },
        { id: 'api-design', file: 'API_Design.html', label: 'API Design', icon: '🔌' },
        { id: 'sequence-diagrams', file: 'Sequence_Diagrams.html', label: 'Sequence Diagrams', icon: '⚙️' },
        { id: 'conclusion', file: 'Conclusion.html', label: 'Conclusion', icon: '✅' }
      ],
      'development': [
        { id: 'overview', file: 'Overview_Content.html', label: 'Overview', icon: '💻' },
        { id: 'agent-orchestration', file: 'Agent_Orchestration.html', label: 'Agent Orchestration', icon: '🧠' },
        { id: 'map-integration', file: 'Map_Integration.html', label: 'Map Integration', icon: '🗺️' },
      ...
      'deployment': [
        { id: 'overview', file: 'Overview_Content.html', label: 'Overview', icon: '🚀' },
        { id: 'deployment-planning', file: 'Deployment_Planning.html', label: 'Deployment Planning', icon: '🗺️' },
        { id: 'environment-setup', file: 'Environment_Setup.html', label: 'Environment Setup', icon: '🔐' },
  ...
  getSubphaseDescription(id) {
    const descriptions = {
      ...
      'design-system': 'Typography, colors, and visual language',
      'discovery-interface': 'Interactive map and search UX',
      'itinerary-builder': 'Task sequencing and route planning',
      'wireframes': 'UI wireframes and user interaction maps',
      'system-architecture': 'Agent-MCP orchestration infrastructure',
      'database-schema': 'Travel data and persistence models',
      'api-design': 'FastAPI resource and SSE definitions',
      'sequence-diagrams': 'Agentic workflow and tool orchestration logic',
      'agent-orchestration': 'Coding the LangGraph reasoning engine',
      'map-integration': 'Implementing React-Leaflet and OSM',
      'backend-development': 'Building the FastAPI Agent server',
      'frontend-development': 'Creating the Discovery Dashboard UI',
      'test-planning': 'Strategy and reasoning eval protocols',
      'unit-testing': 'Validating MCP tool wrappers',
      'integration-testing': 'Full travel discovery cycle verification',
      'performance-testing': 'Latency and resource consumption audit',
      'deployment-planning': 'Cloud architecture and Docker scaling',
      'environment-setup': 'Secret management and cloud config',
      'final-steps': 'Project completion and source code download'
    };
